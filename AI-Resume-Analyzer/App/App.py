# Developed by qaiserfarooq [https://qaiserfarooq-portfolio.netlify.app]    Made with Streamlit
...
# sql connector
connection = pymysql.connect(host='localhost',user='root',password='',db='qaiser')
...
def run():
    ...
    link = '<b>Built  by <a href="https://qaiserfarooq-portfolio.netlify.app/" style="text-decoration: none; color: #021659;">Qaiser Farooq</a></b>' 
    ...
    ###### CODE FOR ABOUT PAGE ######
        ...
        <p align="justify">
            ...
            <b>Admin -</b> <br/>
            For login use <b>admin</b> as username and <b>qaiser1122</b> as password.<br/>
            It will load all the required stuffs and perform analysis.
        </p><br/><br/>

        <p align="justify">
            Built by 
            <a href="https://qaiserfarooq-portfolio.netlify.app/" style="text-decoration: none; color: grey;">Qaiser Farooq</a> with
            <a href="" style="text-decoration: none; color: grey;">Yaseen Ur Rehman </a>
        </p>
    ...
    ###### CODE FOR ADMIN SIDE (ADMIN) ######
        ...
        if st.button('Login'):
            ...
            ## Credentials 
            if ad_user == 'admin' and ad_password == 'qaiser1122':
                ...
                st.success("Welcome Qaiser ! Total %d " % values + " User's Have Used Our Tool : )")                
